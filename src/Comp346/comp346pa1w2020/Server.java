package Comp346.comp346pa1w2020;
...
public class Server implements Runnable{
     ...
     */  
     public void initializeAccounts()
     {
        ...
        try
        {
         inputStream = new Scanner(new FileInputStream("/Users/nianliu/Desktop/First Code/src/Comp346/comp346pa1w2020/account.txt"));
        }
     ...
     {   int accIndex;             	/* Index position of account to update */
         ...
         { 
        	 while( (objNetwork.getInBufferStatus().equals("empty"))
                     && (!objNetwork.getClientConnectionStatus().equals("disconnected"))) Thread.yield();  /* Alternatively, busy-wait until the network input buffer is available */
